...
const Footer: React.FC<footerDataInterface> = (props: footerDataInterface) => {
  ...
  const Links: React.FC = (prop) => {
    ...
    //loop creates elements from footerData prop
          ...
          <ul
            className={
              props.labels.length > 1
                ? "list-none flex flex-col mb-0"
                : "list-none flex justify-center gap-x-3 mb-0"
            }
          >
            {linkList}
          </ul>
        ...
        <div className="container px-6 pt-6">
          <div className="flex justify-center mb-6">
            <a
              href="#!"
              type="button"
              className="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black:400 hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
            >
              <svg
                aria-hidden="true"
                focusable="false"
